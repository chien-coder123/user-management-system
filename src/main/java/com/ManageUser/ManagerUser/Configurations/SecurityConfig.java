package com.ManageUser.ManagerUser.Configurations;
...
public class SecurityConfig {
  ...
  public SecurityFilterChain securityFilterChain(HttpSecurity http)  throws  Exception{
    http.authorizeHttpRequests(request -> {
      request
//                        USER
          .requestMatchers(HttpMethod.POST, "/api/v1/auth/login", "/api/v1/auth/introspect").permitAll()
//          .anyRequest().access(new WebExpressionAuthorizationManager("hasRole('ADMIN') or authentication.authenticated"));
